...
@Component({
  selector: 'app-chat-contacts-page',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './chat-contacts-page.component.html',
  styleUrls: ['./chat-contacts-page.component.css']
})
export class ChatContactsPageComponent {
